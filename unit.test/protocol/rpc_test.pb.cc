...
void protobuf_AssignDesc_rpc_5ftest_2eproto() {
  protobuf_AddDesc_rpc_5ftest_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_rpc_5ftest_2eproto);
}
...
void protobuf_AddDesc_rpc_5ftest_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_rpc_5ftest_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_rpc_5ftest_2eproto {
  StaticDescriptorInitializer_rpc_5ftest_2eproto() {
    protobuf_AddDesc_rpc_5ftest_2eproto();
  }
} static_descriptor_initializer_rpc_5ftest_2eproto_;
...
const TestMessage& TestMessage::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_rpc_5ftest_2eproto();
